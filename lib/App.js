...
class App extends OAuth2App {
  ...
  */
  ...
  registerFlowCards() {
    ...
    // ... and humidity state is ...
    this.homey.flow.getConditionCard('status_humidity').registerRunListener(async ({ device, status_humidity }) => {
      return device.getCapabilityValue('status_humidity') === status_humidity;
    });
